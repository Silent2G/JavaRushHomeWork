...
public class Solution {
    ...
    public String getPartOfString(String string, String threadName) {
        ...
        String result;
            try {
                startSub = string.indexOf("\t");
                endSub = string.lastIndexOf("\t");

                result = string.substring(startSub + 1, endSub);
            } catch (Exception e) {
                ...
                } else if(string.isEmpty() || startSub == -1 || startSub == endSub) {
                    if(threadName.equals(FIRST_THREAD_NAME)) {
                        throw new TooShortStringFirstThreadException(e);
                    } else if(threadName.equals(SECOND_THREAD_NAME)) {
                        throw new TooShortStringSecondThreadException(e);
       ...
       // System.out.println(startSub + " " + endSub);
