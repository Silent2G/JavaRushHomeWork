...
public class Solution {
    ...
    public static void main(String[] args) {
        Date currentDate = new Date(2017,2,15);
        Set<Solution> s = new HashSet<>();
        s.add(new Solution(35, "Stas", 10, currentDate, null));
        System.out.println(s.contains(new Solution(35, "Stas", 10, currentDate, null)));
    }
}
